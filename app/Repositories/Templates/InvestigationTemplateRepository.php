...
use App\Models\Templates\InvestigationTemplate;
use App\Models\User;
use App\Repositories\BaseRepository;
use App\Repositories\TemplateSettingRepository;

class InvestigationTemplateRepository extends BaseRepository
{
    public function getPaginate($offset = 10, $fields = ['id'], $condition = [], $relations = [], $searchData = '', $for = 'all')
    {
        $query = InvestigationTemplate::query();
        if ($for === 'user_specific') {
            ...
            if(!$templateSetting){
                ...
                $query = $this->searchFor($templateSetting->templates['investigation'], $query);
            }
        }
    ...
    public function create($payload)
    {
        ...
        return InvestigationTemplate::create($data);
    }
