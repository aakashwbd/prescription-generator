...
use App\Models\Templates\OnExaminationTemplate;
use App\Models\User;
use App\Repositories\BaseRepository;
use App\Repositories\TemplateSettingRepository;

class OnExaminationTemplateRepository extends BaseRepository
{
    public function getPaginate($offset = 10, $fields = ['id'], $condition = [], $relations = [], $searchData = '', $for = 'all')
    {
        $query = OnExaminationTemplate::query();
        if ($for === 'user_specific') {
            ...
            if(!$templateSetting){
                ...
                $query = $this->searchFor($templateSetting->templates['on_examination'], $query);
            }
        }
    ...
    public function create($payload)
    {
        ...
        return OnExaminationTemplate::create($data);
    }
