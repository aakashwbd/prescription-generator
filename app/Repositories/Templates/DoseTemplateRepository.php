...
class DoseTemplateRepository extends BaseRepository
{
    public function getPaginate($offset = 10, $fields = ['id'], $condition = [], $relations = [], $searchData = '', $for = 'all')
    {
        ...
        if ($for === 'user_specific') {
            ...
            if(!$templateSetting){
                ...
                $query = $this->searchFor($templateSetting->templates['dose'], $query);
            }
        }
    ...
    public function create($payload)
    {
        ...
        return DoseTemplate::create($data);
    }
