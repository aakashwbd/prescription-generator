...
use App\Models\Templates\MedicineTemplate;
use App\Models\User;
use App\Repositories\BaseRepository;
use App\Repositories\TemplateSettingRepository;

class MedicineTemplateRepository extends BaseRepository
{
    public function getPaginate($offset = 10, $fields = ['id'], $condition = [], $relations = [], $searchData = '', $for = '')
    {
        ...
        if ($for === 'user_specific') {
            ...
            if(!$templateSetting){
                ...
                $query = $this->searchFor($templateSetting->templates['medicine'], $query);
            }
        }
    ...
    public function create($payload)
    {
        ...
        return MedicineTemplate::create($data);
    }
