...
use App\Models\Templates\CubicCentimeterTemplate;
use App\Models\User;
use App\Repositories\BaseRepository;
use App\Repositories\TemplateSettingRepository;

class CubicCentimeterTemplateRepository extends BaseRepository
{

    public function getPaginate($offset = 10, $fields = ['id'], $condition = [], $relations = [], $searchData = '', $for = 'all')
    {
        $query = CubicCentimeterTemplate::query();
        ...
        if ($for === 'user_specific') {
            ...
            if(!$templateSetting){
                ...
                $query = $this->searchFor($templateSetting->templates['cubic_centimeter'], $query);
            }
        }
    ...
    public function create($payload)
    {
        ...
        return CubicCentimeterTemplate::create($data);
    }
